...
export function StatusBar() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-30 flex items-center gap-6 border-t border-white/[0.06] bg-gradient-to-r from-white/[0.02] via-white/[0.03] to-white/[0.02] backdrop-blur-xl px-4 py-1.5 text-[11px] font-light tracking-wide">
